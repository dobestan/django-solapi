# Generated by Django 6.0 on 2026-01-03 12:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("phone", models.CharField(db_index=True, max_length=20, verbose_name="수신번호")),
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("SUCCESS", "성공"), ("FAILED", "실패"), ("SKIPPED", "스킵")],
                        max_length=20,
                        verbose_name="발송상태",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("expires_at", models.DateTimeField(db_index=True, verbose_name="만료시간")),
                (
                    "verified_at",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["phone", "-created_at"], name="solapi_sms__phone_52bd82_idx"
                    )
                ],
            },
        ),
